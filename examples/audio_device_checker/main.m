//
//  main.m
//  AudioDeviceChecker for MacOS
//
//  Created by uezo on 2024/02/27.
//
...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        // Get audio devices as array
        CFArrayRef devices = CreateInputDeviceArray();
        if (devices == NULL) {
        ...
        for (CFIndex i = 0; i < deviceCount; i++) {
            CFDictionaryRef deviceInfo = CFArrayGetValueAtIndex(devices, i);
            CFStringRef deviceUID = CFDictionaryGetValue(deviceInfo, CFSTR("deviceUID"));
            CFStringRef deviceName = CFDictionaryGetValue(deviceInfo, CFSTR("deviceName"));

            // Print device info
            NSLog(@"Device UID: %@, Name: %@", deviceUID, deviceName);
        }
