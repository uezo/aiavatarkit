...
from aiavatar.sts.llm.litellm import LiteLLMService, ToolCall
...
@pytest.mark.asyncio
async def test_litellm_service_dynamic_tools():
    """
    Test LiteLLMService with dynamic tools.
...
@pytest.mark.asyncio
async def test_litellm_service_guardrails():
    """
    Test LiteLLMService with guardrails.
    """
    service = LiteLLMService(
        api_key=CLAUDE_API_KEY,
